...
var Bitcore = require('bitcore-lib-cmm');
var Bitcore_ = {
  cmm: Bitcore,
 ...
 * @param {string} opts.coin[='cmm'] - The coin for this wallet (btc, bch).
 ...
 * @param {string} opts.coin[='cmm'] - The expected coin for this wallet (btc, bch).
...
WalletService.prototype.savePreferences = function(opts, cb) {
  ...
  var preferences = [{
    ...
    name: 'unit',
    isValid: function(value) {
      return _.isString(value) && _.contains(['cmm', 'bit'], value.toLowerCase());
    },
  }];
 ...
 * @param {Object} opts
 * @param {String} [opts.coin='cmm'] (optional)
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'cmm'] - The coin to estimate fee levels from.
 ...
 * @param {Object} opts
 * @param {string} [opts.coin = 'cmm'] - The coin for this transaction.
